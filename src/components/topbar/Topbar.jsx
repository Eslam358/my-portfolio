    ...
    <div className={mainpro ? "topbar active" : "topbar "}>
      <div className="topbar-con ">
        <div className="topbar-right">
          <h2 className="logo pacifico-regular" href="#">
            Eslam
            <span
          ...
          <div className={show ? "info active" : "info"}>
            <div>
              <a target="_blank" href="https://eslam900aa@gmail.com"  rel="noreferrer">
            ...
            <div>
              <a target="_blank" href="https://wa.me/qr/BF5TOKTUKX4IA1" rel="noreferrer"  >
